...
> [!IMPORTANT]
> **Fork delta from upstream `jermp/fulgor` `v4.0.0`**
>
> This repository is a fork of [jermp/fulgor](https://github.com/jermp/fulgor) based on `v4.0.0`.
...
>
> Relative to standard upstream Fulgor `v4.0.0`, this fork changes only:
>
